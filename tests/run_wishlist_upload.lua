...
assert(StaticPopupDialogs["WISHLISTREALIZER_APPLY_WISHLIST"],
    "confirmation dialog definition was never registered")
assert(type(StaticPopupDialogs["WISHLISTREALIZER_APPLY_WISHLIST"].OnAccept) == "function",
    "confirmation dialog has no OnAccept handler")
