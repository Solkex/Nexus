...
for i=1,100 do
 ...
 assert(DPS.ReceiveRecord({v=6,f=fp,e=echoes,c="dummy",d=1000000+i*10000,u=65,t=i,p="Player"..i,l=80,b=id}))
end
...
assert(DPS.ReceiveRecord({v=6,f=DPS.GetEchoKey(better),e=better,c="dummy",d=9000000,u=65,t=200,p="Player50",l=80,b="stress-50b"}))
