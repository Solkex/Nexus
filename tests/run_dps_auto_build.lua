...
assert(DPS.ReceiveRecord({v=3,f=fp,e=echoes,c="dummy",d=27000000,u=65,t=60000,p="Othermage",l=80,b=buildId}), "higher remote record should be accepted")
assert(DPS.ReceiveRecord({v=3,f=fp,e=echoes,c="dummy",d=25000000,u=65,t=60001,p="Oldmage",l=80,b=buildId}), "a different character should keep its own best entry")
assert(not DPS.ReceiveRecord({v=3,f=fp,e=echoes,c="dummy",d=24000000,u=65,t=60002,p="Oldmage",l=80,b=buildId}), "a lower record for the same character should be rejected")
