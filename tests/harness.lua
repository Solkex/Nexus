    ...
    meta = {
        __index = function(t, k)
            ...
            elseif k == "GetFrameLevel" then
                return function(self) return self.level or 0 end
            elseif k == "SetValue" then
                return function(self, v) self.sliderValue = v end
            elseif k == "GetValue" then
                return function(self) return self.sliderValue or 0 end
            ...
            elseif k == "GetMinMaxValues" then
                return function(self)
                    return self.sliderMin or 0, self.sliderMax or 1
                end
            ...
            elseif k == "GetWidth" then
                return function(self) return self.w or 100 end
            elseif k == "GetHeight" then
                return function(self) return self.h or 20 end
